...
class TextStyles {
  ...
  static final linksPequenos = GoogleFonts.inter(
    fontSize: 15,
    fontWeight: FontWeight.w400,
  ...
  static final itensMenu = GoogleFonts.lexendDeca(
    fontSize: 18,
    fontWeight: FontWeight.w500,
    color: AppColors.heading,
  );
  static final itensMenuPrecos = GoogleFonts.lexendDeca(
    fontSize: 16,
    fontWeight: FontWeight.w500,
    color: Colors.grey,
  );
  static final valorTotal = GoogleFonts.lexendDeca(
    fontSize: 24,
    fontWeight: FontWeight.w700,
    color: AppColors.primary,
  );
